...
import org.esfe.LLVG20240910.Modelos.ProductLLVG;  // Actualizado aquí
import org.esfe.LLVG20240910.Repositorios.IProductoRepository;
...
@Service
public class ProductoService implemenst IProductoServicio{
    @Autowired
    ...
    public ProductoSalida obtenerPorId(Integer id) {
        return modelMapper.map(productoRepository.findById(id)
                .orElseThrow(() -> new RuntimeException("Producto no encontrado")), ProductoSalida.class);
    }
